...
//  LineApp
//
//  Created by 徐天宇 on 14-8-14.
//  Copyright (c) 2014年 Tiptap. All rights reserved.
//
...
#ifndef LineApp_Header_h
#define LineApp_Header_h
...
//portrait ONLY
#define  IS_35_UIScreen     (IS_Iphone && [UIScreen mainScreen].bounds.size.height == 480)
#define  IS_4_UIScreen      (IS_Iphone && [UIScreen mainScreen].bounds.size.height == 568)
#define  IS_47_UIScreen     (IS_Iphone && [UIScreen mainScreen].bounds.size.height == 667)
#define  IS_55_UIScreen     (IS_Iphone && [UIScreen mainScreen].bounds.size.height == 736)
//判断是否为iPad
...
//是否IOS6之前
#define IS_BEFORE_IOS6 [[[UIDevice currentDevice] systemVersion] doubleValue] <= 6
//是否IOS5之前
...
//用户的目录
#define  User_Document      [NSString stringWithFormat:@"/%@",[[NSUserDefaults standardUserDefaults] objectForKey:kUserName]]
//是否英文
#define isEnglish     ([[[NSUserDefaults standardUserDefaults] objectForKey:kLanguageType]isEqualToString:@"en"]?YES:NO)
...
#define BLUECOLOR RGBACOLOR(30, 60, 140, 1)
// View 圆角和加边框
